/**
 * author         : 우태균
 * description    : 기본적인 비동기 수동 커밋 로직이 포함된 컨슈머
 */
package org.example;
 ...
 */
public class ConsumerWithBasicAsyncCommit {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      //가져온 레코드들에 대한 모든 작업(비즈니스 로직)을 끝낸 후, 해당 레코드들에 대해 커밋 (commitAsync 메서드: 비동기적으로 동작하는 커밋. 따라서 커밋이 완료될 때까지 대기하지 않음.)
