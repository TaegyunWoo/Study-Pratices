...
| **1. 기초 및 처리 모델** | **2. 파라미터와 스코프** | **3. 도메인 및 메타데이터** |
|:---|:---|:---|
| [태스크릿 지향 처리](#태스크릿-지향-처리) | [JobParameters](#jobparameters) | [Job과 메타데이터 저장소](#job과-메타데이터-저장소) |
| [청크 지향 처리](#청크-지향-처리) | [JobParameters 전달 방법](#다양한-jobparameters-전달-방법) | [JobInstance](#jobinstance-job의-논리적-실행-단위) |
| [ItemReader](#itemreader--데이터-읽기) | [Parameter 값 검증](#job-parameter-값-검증) | [JobExecution](#jobexecution-jobinstance의-실제-실행-시도이력) |
| [ItemProcessor](#itemprocessor--데이터-가공-및-처리) | [Job 과 Step 의 Scope](#job-과-step-의-scope) | [StepExecution](#stepexecution-step의-실제-실행-시도이력) |
| [ItemWriter](#itemwriter--데이터-쓰기) | [@JobScope](#jobscope) · [@StepScope](#stepscope) | [ExecutionContext](#executioncontext--상태-저장소) |
| | [Scope 주의사항](#jobscope-와-stepscope-사용시-주의사항) | [메타데이터 테이블 구조](#배치-메타데이터-테이블-구조) |
| | | [AutoConfiguration](#spring-batch-의-autoconfiguration) |
| | | [@EnableBatchProcessing](#enablebatchprocessing) |

| **4. I/O (읽기 & 쓰기)** | **5. 데이터 가공 및 리스너** | **6. 내결함성** |
|:---|:---|:---|
| [FlatFileItemReader](#flatfileitemreader) | [Listener 개요](#spring-batch-listener) | [Retry](#retry) |
| [FlatFileItemWriter](#flatfileitemwriter) | [JobExecutionListener](#jobexecutionlistener) | [RetryTemplate](#retrytemplate--retry-의-핵심-컴포넌트) |
| [FlatFile 실전 예제](#flatfileitemreader-와-flatfileitemwriter-실전-예제) | [StepExecutionListener](#stepexecutionlistener) | [RetryPolicy](#retrypolicy--재시도-정책-관리) |
| [JSON 읽고 쓰기](#json-파일-읽고-쓰기-예제) | [ChunkListener](#chunklistener) | [BackOffPolicy](#backoffpolicy) |
| [JdbcCursorItemReader](#jdbccursoritemreader--커서-기반-처리) | [리스너 구현 방법](#배치-리스너-구현-방법) | [Skip](#skip) |
| [JdbcPagingItemReader](#jdbcpagingitemreader--페이징-기반-처리) | [ExecutionContext 활용](#jobexecutionlistener-와-executioncontext-를-활용한-동적-데이터-전달) | [SkipPolicy](#skippolicy) |
| [JdbcBatchItemWriter](#jdbcbatchitemwriter-구성요소) | [ItemProcessor 처리 방식](#itemprocessor-의-데이터-처리-방식) | [SkipListener](#skiplistener--건너뛴-아이템-추적-및-후속-처리) |
| [JpaCursorItemReader](#jpacursoritemreader) | [CompositeItemProcessor](#compositeitemprocessor--여러-itemprocessor-사용하기) | [noRollback()](#norollback-을-통한-성능-최적화) |
| [JpaPagingItemReader](#jpapagingitemreader) | | |
| [JpaItemWriter](#jpaitemwriter) | | |
| [위임 ItemWriter/Reader](#위임-itemwriter-와-itemreader) | | |
| [ItemStream](#itemstream) | | |

| **7. 고급 제어 및 실행** | **8. 성능 최적화** | **9. 설정 및 테스트** |
|:---|:---|:---|
| [ExitCode 조작](#커맨드라인에서의-exitcode-조작) | [멀티스레드 스텝](#멀티스레드-스텝) | [Spring Batch Test](#spring-batch-test) |
| [ExitCode 변경](#exitcode-변경하기) | [스레드 안전성](#멀티스레드-환경에서의-스레드-안전성) | [E2E 테스트](#e2e-테스트---전체-배치-잡을-테스트하기) |
| [REST API 와 JobOperator](#rest-api-를-통한-job-실행과-jopoperator) | [파티셔닝](#파티셔닝) | [단위 테스트](#단위-테스트---개별-컴포넌트-테스트하기) |
| [JobOperator](#joboperator-배치-작업의-완전한-제어) | [Partitioner](#partitioner) | |
| [Batch Flow](#batch-flow) | [파일 기반 Partitioner](#파일-기반-partitioner) | |
| [Flow 분기 제어](#커스텀-exitcode를-활용한-flow-분기-제어) | | |
